(function (window, undefined) {
    ...
    function fCreateClass(sPackage, sClassName) {
        console.log("xiepuxin fCreateClass");
        var Class = function () {
        ...
        console.log("xiepuxin fCreateClass arguments.length != 0 , arguments.length = " + arguments.length);

        var oParent;
        if (arguments.length === 2 && typeof sPackage !== 'string') {
            oParent = _fFixParent(sPackage);
            oParent[sClassName] = Class;
            console.log("xiepuxin fCreateClass arguments.length === 2 && typeof sPackage !== 'string'");
        } else {
            console.log("xiepuxin fCreateClass arguments.length === 2 && typeof sPackage !== 'string' else");
            ...
            for (var i = 0, l = aName.length; i < l; i++) {
                ...
                if (i + 1 === l) {
                    if (typeof oParent[sName] === 'function') {
                        console.log("xiepuxin fCreateClass Class = oParent[sName];");
                        Class = oParent[sName];
                    } else {
                        oParent[sName] = Class;
                    }
